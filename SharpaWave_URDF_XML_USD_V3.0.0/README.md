...
3. USD Files:
  - `src/left_sharpa_wave/left_sharpa_wave.usd` for left hand.
  - `src/right_sharpa_wave/right_sharpa_wave.usd` for right hand.
  - `src/dual_sharpa_wave.usd` for dual hand.
4. Each fingertip has three coordinate frames:  
